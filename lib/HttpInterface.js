//
// IDUP Monit and Server web interface
...
http.createServer(function (req, res) {
  ...
  console.log('Access on IDUP monit point %s', path);


  if (path == '/') {
    // Main monit route
    Bridge.executeRemote('getMonitorData', {}, function(err, data_proc) {
      var data = {
...
//   Bridge.executeRemote("list", {}, function(err, data_proc) {
//     console.log('adding');
//     fdb.add(data_proc);
//   });
// }, 1000);
